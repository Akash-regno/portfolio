...
export default function ProjectsPage() {
  useEffect(() => {
    ...
    return () => {
      // Remove dark theme class on unmount
      document.body.classList.remove('dark-theme')
    }
  }, [])

  return (
    <section className="projects-page-sec">
      <div className="wrapper">
        <div className="projects-page-header">
          <h1 className="reveal">Selected<br />Works</h1>
          <p className="projects-page-intro reveal reveal-delay-1">
            A showcase of deep-dive engineering, full-stack applications, and technical experiments built with modern architecture.
          </p>
        </div>
